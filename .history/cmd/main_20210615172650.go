...
func main() {
	...
	//}
	kafka.Count("uae-a4", []string{"kafka-0.kafka.uae-system.svc.a4.uae:9092", "kafka-1.kafka.uae-system.svc.a4.uae:9092", "kafka-2.kafka.uae-system.svc.a4.uae:9092", "kafka-3.kafka.uae-system.svc.a4.uae:9092", "kafka-4.kafka.uae-system.svc.a4.uae:9092"})
}
