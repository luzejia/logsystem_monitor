...
func Count(clsuter string, KafkaClusterAddr []string) {
	...
	//KafkaClusterAddr := []string{"kafka-a1-log-headless.uae-system.svc.c1.uae:9092"}
	...
	produce_speed = produce_speed / 30
	...
	for key1, value1 := range offset2 {
		...
		for key2, value2 := range value1 {
			...
			fmt.Println("consume speed:", (value2-offset1[key1][key2])/30)
		}
	}
