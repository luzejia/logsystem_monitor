...
func Count() {
	Querycmd := fmt.Sprintf("curl -s -X GET \"elasticsearch-logging.uae-system.svc.a1.uae:9200/_cat/indices/uae-*?v=true&h=index,store.size,docs.count&bytes=mb&format=json\"")
	...
	fmt.Println(yesterday, "kun all namesapce message size:", SizeCount/1024/1024/1024, "Tb", "kun all message message count:", NumCount)
