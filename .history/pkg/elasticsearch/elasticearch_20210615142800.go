...
func Count(cluster string) {
	Querycmd := fmt.Sprintf("curl -s -X GET \"elasticsearch-logging.uae-system.svc.a1.uae:9200/_cat/indices/uae-*-2021-06-14?v=true&h=index,store.size,docs.count&bytes=kb&format=json\"")
